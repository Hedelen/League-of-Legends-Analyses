...
def get_settings(require_api_key: bool = True) -> Settings:
    ...
    return Settings(
        ...
        target_reference_players=_int("TARGET_REFERENCE_PLAYERS", 100, 1),
        ...
        target_reference_player_games=_int(
            "TARGET_REFERENCE_PLAYER_GAMES", 1000, 1
        ),
        reference_games_per_player=_int("REFERENCE_GAMES_PER_PLAYER", 10, 1),
